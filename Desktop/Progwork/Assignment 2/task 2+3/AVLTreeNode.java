...
public class AVLTreeNode {
    ...
    private AVLTreeNode() { this.key=null; this.height=-1; this.value=null; this.left=null; this.right=null; this.parent=null;}
     ...
     * @param key
     */
    public AVLTreeNode(Integer key, String value) { this(null, key, value, null, null); }
    
    private AVLTreeNode(AVLTreeNode left, Integer key, String value, AVLTreeNode right, AVLTreeNode parent) {
        assert(key!=null);
        this.left=left;
        this.right=right;
        this.key=key;
    ...
    /**
     * Obtain the height value stored at this node.
     */
    public int getHeight() {
        if(this == null) this.setHeight(0);
        return this.height;
    }
